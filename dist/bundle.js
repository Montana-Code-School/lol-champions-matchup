...
var _lolChampions = __webpack_require__(27);
...
var SearchButton = function (_React$Component) {
  ...
  function SearchButton(props) {
    ...
    _lolChampions2.default.state = { name: "" };
    return _this;
  }
  ...
  _createClass(SearchButton, [{
    ...
    value: function buttonClicked() {
      fetch("http://ddragon.leagueoflegends.com/cdn/6.24.1/data/en_US/champion.json").then(function (data) {
        console.log(data.body.getReader().read().then(function (thing) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { className: 'inputs', onClick: this.buttonClicked },
          'Search Champions'
        )
      );
    }
