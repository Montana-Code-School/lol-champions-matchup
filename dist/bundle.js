...
var request = "http://ddragon.leagueoflegends.com/cdn/7.15.1/data/en_US/champion.json?api_key=RGAPI-3ff47e8c-88b0-4f8d-a108-280272dd665d";
...
var SearchButton = function (_React$Component) {
  ...
  _createClass(SearchButton, [{
    ...
    value: function onNameChange(e) {
      var valueLower = String(e.target.value).toLowerCase();
      var champNames = Object.keys(this.state.allChamps);
      champNames = champNames.map(function (name) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement('input', { id: 'inputText', type: 'text', name: 'name', onChange: function onChange(e) {
            return _this3.onNameChange(e);
          } }),
        _react2.default.createElement(
          'button',
          { className: 'inputs', onClick: function onClick() {
              return _this3.onButtonClick();
            } },
          'Search Champions'
        ),
        this.state.champNames.map(function (name) {
          return _react2.default.createElement(
            'p',
            null,
            name
...
(0, _reactDom.render)(_react2.default.createElement(SearchButton, null), document.getElementById('ChampBox'));
